...
L.Draw.Polyline = L.Draw.Feature.extend({
	...
	options: {
		...
		zIndexOffset: 999999 //2000  This should be > than the highest z-index any map layers
	},
...
L.Draw.Marker = L.Draw.Feature.extend({
	...
	options: {
		...
		repeatMode: false,
		zIndexOffset: 999999 // 2000 This should be > than the highest z-index any markers
	},
...
L.Tooltip = L.Class.extend({
	...
	updateContent: function (labelText) {
		...
		labelText.subtext = labelText.subtext || '1234567';
