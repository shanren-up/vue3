    ...
    var // currently active contextMenu trigger
                ...
                if (!$this.hasClass('context-menu-disabled')) {
                    ...
                    for (var item in e.data.items) {
                        if (e.data.items.hasOwnProperty(item)) {
                            var visible;
                            //取消function的判断 delete by tianpeng
        ...
        op = {
            show: function(opt, x, y) {
                ...
                // hide any open menus
                // $(document).trigger('mousedown',opt.selector);
            ...
            layer: function(opt, zIndex) {
                ...
                var $layer = opt.$layer = $(document)
                    .on('contextmenu', opt.selector, handle.abortevent.bind(opt.selector))
                    .on('mousedown', document, handle.layerClick.bind(document));
                $(opt.selector).data('contextMenuRoot', opt);
                $(document).data('contextMenuRoot', opt);
    ...
    $.contextMenu = function(operation, options) {
        ...
        switch (operation) {
            case 'create':
                ...
                if (!initialized) {
                    var itemClick = o.itemClickEvent === 'click' ? 'click.contextMenu' : 'mousedown.contextMenu';
