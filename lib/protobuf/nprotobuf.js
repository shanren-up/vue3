...
(function(global, factory) {
    ...
    ProtoBuf.Reflect = (function(ProtoBuf) {
        ...
        NamespacePrototype.buildOpt = function() {
            ...
            for (var i=0, k=this.options.length; i<k; ++i) {
                var key = this.options[i],
                    val = this.options[this.options[i]];
                // TODO: Options are not resolved, yet.
                // if (val instanceof Namespace) {
                //     opt[key] = val.build();
                // } else {
            ...
            switch (this.type) {
                ...
                case ProtoBuf.TYPES["sfixed64"]: {
                    if (ProtoBuf.Long)
                        ...
                        fail(typeof value, "requires pblong.js");
                }
        ...
        Enum.getName = function(enm, value) {
           /*  var keys = Object.keys(enm);
			...
			在末尾会多出一个$options对象 */
			var keys = Object.getOwnPropertyNames(enm);
            for (var i=0, key; i<keys.length - 1; ++i)
                if (enm[key = keys[i]] === value)
                    return key;
            return null;
        };
            ...
            while (stack.length > 0) {
                ...
                while (defs.length > 0) {
                    ...
                    if (Builder.isMessage(def)) {
                        ...
                        if (def["oneofs"])
							var keys = [];
							for(var i = 0;i < def["oneofs"].length;i++){
								keys[i] = i;
							}
						...
						var keys = [];
						for(var i = 0;i < def["rpc"].length;i++){
							keys[i] = i;
						}
						keys.forEach(function(name) {
        ...
        var Map = function(field, contents) {
            ...
            if (contents) {
               /*  var keys = Object.keys(contents); */
			    var keys = Object.getOwnPropertyNames(contents);
