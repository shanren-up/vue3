...
goog.crypt.base64.init_ = function() {
    if (!goog.crypt.base64.byteToCharMap_) {
        ...
        for (var a = 0; a < goog.crypt.base64.ENCODED_VALS.length; a++)
            goog.crypt.base64.byteToCharMap_[a] = goog.crypt.base64.ENCODED_VALS.charAt(a),
            goog.crypt.base64.charToByteMap_[goog.crypt.base64.byteToCharMap_[a]] = a,
            goog.crypt.base64.byteToCharMapWebSafe_[a] = goog.crypt.base64.ENCODED_VALS_WEBSAFE.charAt(a),
...
jspb.Map.prototype.toArray = function() {
    if (this.arrClean) {
        if (this.valueCtor_) {
            var a = this.map_, b;
            for (b in a)
                Object.prototype.hasOwnProperty.call(a, b) && a[b].valueWrapper.toArray()
        }
    } else {
        this.arr_.length = 0;
        a = this.stringKeys_();
...
jspb.Map.prototype.set = function(a, b) {
    ...
    this.valueCtor_ ? (c.valueWrapper = b,
...
jspb.Map.deserializeBinary = function(a, b, c, d, e) {
    for (var f = void 0, g = void 0; b.nextField() && !b.isEndGroup(); ) {
        ...
        1 == h ? f = c.call(b) : 2 == h && (a.valueCtor_ ? (g = new a.valueCtor_,
...
jspb.Message.initialize = function(a, b, c, d, e, f) {
    ...
    if (e)
        for (b = 0; b < e.length; b++)
            c = e[b],
            c < a.pivot_ ? (c = jspb.Message.getIndex_(a, c),
...
jspb.Message.materializeExtensionObject_ = function(a, b) {
    ...
    -1 < b ? (a.pivot_ = b,
    c = jspb.Message.getIndex_(a, b),
    a.extensionObject_ = jspb.Message.MINIMIZE_MEMORY_ALLOCATIONS ? null : a.array[c] = {}) : a.pivot_ = Number.MAX_VALUE
}
;
...
jspb.Message.readBinaryExtension = function(a, b, c, d, e) {
    ...
    if (f) {
        ...
        var g;
        c.isMessageType() ? (g = new c.ctor,
        f.binaryReaderFn.call(b, g, f.binaryMessageDeserializeFn)) : g = f.binaryReaderFn.call(b);
...
;
jspb.Message.getFieldProto3 = function(a, b, c) {
...
jspb.Message.getMapField = function(a, b, c, d) {
    ...
    if (!c)
        return c = jspb.Message.getField(a, b),
        c || (c = [],
...
jspb.Message.computeOneofCase = function(a, b) {
    ...
    goog.array.forEach(b, function(b) {
        ...
        goog.isDefAndNotNull(f) && (c = b,
        d = f,
        jspb.Message.setField(a, b, void 0))
    });
    return c ? (jspb.Message.setField(a, c, d),
    c) : 0
}
;
...
jspb.Message.prototype.getExtension = function(a) {
    if (this.extensionObject_) {
        ...
        if (a.isRepeated) {
            ...
            return !this.wrappers_[b] && this.extensionObject_[b] && (this.wrappers_[b] = new a.ctor(this.extensionObject_[b])),
            this.wrappers_[b];
...
jspb.Message.prototype.setExtension = function(a, b) {
    ...
    var c = a.fieldIndex;
    a.isRepeated ? (b = b || [],
    a.isMessageType() ? (this.wrappers_[c] = b,
...
jspb.Message.difference = function(a, b) {
    ...
    a.getJsPbMessageId() && (e[0] = a.getJsPbMessageId(),
    f = 1);
    for (; f < g; f++)
...
jspb.Message.compareFields = function(a, b) {
    ...
    if (a.constructor === Array) {
        for (var d = void 0, e = void 0, f = Math.max(a.length, b.length), c = 0; c < f; c++) {
            var g = a[c]
              , h = b[c];
            g && g.constructor == Object && (goog.asserts.assert(void 0 === d),
            goog.asserts.assert(c === a.length - 1),
            d = g,
            g = void 0);
            h && h.constructor == Object && (goog.asserts.assert(void 0 === e),
        ...
        return d || e ? (d = d || {},
        e = e || {},
        jspb.Message.compareExtensions(d, e)) : !0
    }
...
jspb.utils.splitFloat32 = function(a) {
    ...
    a = b ? -a : a;
    var c;
    0 === a ? 0 < 1 / a ? (jspb.utils.split64High = 0,
    jspb.utils.split64Low = 0) : (jspb.utils.split64High = 0,
    jspb.utils.split64Low = 2147483648) : isNaN(a) ? (jspb.utils.split64High = 0,
    jspb.utils.split64Low = 2147483647) : a > jspb.BinaryConstants.FLOAT32_MAX ? (jspb.utils.split64High = 0,
    jspb.utils.split64Low = (b << 31 | 2139095040) >>> 0) : a < jspb.BinaryConstants.FLOAT32_MIN ? (a = Math.round(a / Math.pow(2, -149)),
    jspb.utils.split64High = 0,
    jspb.utils.split64Low = (b << 31 | a) >>> 0) : (c = Math.floor(Math.log(a) / Math.LN2),
    a *= Math.pow(2, -c),
...
jspb.utils.joinUnsignedDecimalString = function(a, b) {
    ...
    var d = (a >>> 24 | b << 8) >>> 0 & 16777215
      ...
      , d = d + 8147497 * e
      , e = 2 * e;
    1E7 <= f && (d += Math.floor(f / 1E7),
    f %= 1E7);
    1E7 <= d && (e += Math.floor(d / 1E7),
    d %= 1E7);
...
jspb.BinaryIterator.prototype.next = function() {
    ...
    this.decoder_ ? this.decoder_.atEnd() ? (this.nextValue_ = null ,
...
jspb.BinaryDecoder.prototype.readUnsignedVarint32 = function() {
    ...
    c |= (a & 15) << 28;
    if (128 > a)
        return goog.asserts.assert(0 == (a & 240)),
        this.cursor_ += 5,
        goog.asserts.assert(this.cursor_ <= this.end_),
        c >>> 0;
...
jspb.BinaryEncoder.prototype.writeString = function(a) {
    for (var b = this.buffer_.length, c = 0; c < a.length; c++) {
        var d = a.charCodeAt(c);
        128 > d ? this.buffer_.push(d) : (2048 > d ? this.buffer_.push(d >> 6 | 192) : (this.buffer_.push(d >> 12 | 224),
...
jspb.BinaryWriter.prototype.writeUnsignedVarint32_ = function(a, b) {
    null != b && (this.writeFieldHeader_(a, jspb.BinaryConstants.WireType.VARINT),
...
jspb.BinaryWriter.prototype.writeBool = function(a, b) {
    null != b && (goog.asserts.assert(goog.isBoolean(b)),
    this.writeFieldHeader_(a, jspb.BinaryConstants.WireType.VARINT),
...
jspb.BinaryWriter.prototype.writeMessage = function(a, b, c) {
    null != b && (a = this.beginDelimited_(a),
    c(b, this),
...
jspb.BinaryWriter.prototype.writeFixedHash64 = function(a, b) {
    null != b && (goog.asserts.assert(8 == b.length),
    this.writeFieldHeader_(a, jspb.BinaryConstants.WireType.FIXED64),
