...
*/
(function(e){"function"===typeof define&&define.amd?define(["jquery","jdataTables"],function(i){return e(i,window,document)}):"object"===typeof exports?module.exports=function(i,l){i||(i=window);if(!l||!l.fn.dataTable)l=require("jdataTables")(i,l).$;return e(l,i,i.document)}:e(jQuery,window,document)})(function(e,i,l,j){function q(c){var a=c.settings()[0]._select.selector;e(c.table().body()).off("mousedown.dtSelect",a).off("mouseup.dtSelect",a).off("click.dtSelect",a);e("body").off("click.dtSelect")}
