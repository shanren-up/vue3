(function e(t, n, r) {
	...
	1: [function(require, module, exports) {
		function corslite(n, o, t) {
			...
			return "onload" in r ? r.onload = e : r.onreadystatechange = function() {
				...
				o.call(this, n || !0, null), o = function() {}
			}, r.onprogress = function() {}, r.ontimeout = function(n) {
				o.call(this, n, null), o = function() {}
	...
	3: [function(require, module, exports) {
		! function(t, e, i) {
			...
			"object" == typeof module && "object" == typeof module.exports ? module.exports = o : "function" == typeof define && define.amd && define(o), void 0 !== t && function() {
					var e = t.L;
					...
					template: function(t, e) {
						return t.replace(o.Util.templateRe, function(t, i) {
							var o = e[i];
						...
						if(this._events && (n = this._events[t])) {
							...
							if(i === this && (i = void 0), n)
								for(s = 0, r = n.length; s < r; s++) {
									var a = n[s];
									if(a.ctx === i && a.fn === e) return a.fn = o.Util.falseFn, this._firingCount && (this._events[t] = n = n.slice()), void n.splice(s, 1)
								}
						}
					},
					fire: function(t, e, i) {
			...
			n.addEventListener = n.on, n.removeEventListener = n.clearAllEventListeners = n.off, n.addOneTimeEventListener = n.once, n.fireEvent = n.fire, n.hasEventListeners = n.listens, o.Mixin = {
					Events: n
				},
				function() {
					...
					create: function(t, i, o) {
						...
						return n.className = i || "", o && o.appendChild(n), n
					},
					remove: function(t) {
						var e = t.parentNode;
						e && e.removeChild(t)
					...
					addClass: function(t, e) {
						if(void 0 !== t.classList)
							for(var i = o.Util.splitWords(e), n = 0, s = i.length; n < s; n++) t.classList.add(i[n]);
					...
					testProp: function(t) {
						for(var i = e.documentElement.style, o = 0; o < t.length; o++)
				...
				function() {
					...
					initialize: function(t, e) {
						e = o.setOptions(this, e), this._initContainer(t), this._initLayout(), this._onResize = o.bind(this._onResize, this), this._initEvents(), e.maxBounds && this.setMaxBounds(e.maxBounds), void 0 !== e.zoom && (this._zoom = this._limitZoom(e.zoom)), e.center && void 0 !== e.zoom && this.setView(o.latLng(e.center), e.zoom, {
							reset: !0
					...
					setView: function(t, e, i) {
						if(e = void 0 === e ? this._zoom : this._limitZoom(e), t = this._limitCenter(o.latLng(t), e, this.options.maxBounds), i = i || {}, this._stop(), this._loaded && !i.reset && !0 !== i) {
							...
							if(this._zoom !== e ? this._tryAnimatedZoom && this._tryAnimatedZoom(t, e, i.zoom) : this._tryAnimatedPan(t, i.pan)) return clearTimeout(this._sizeTimer), this
						}
					...
					flyTo: function(t, e, i) {
						...
						if(i = i || {}, !1 === i.animate || !o.Browser.any3d) return this.setView(t, e, i);
						this._stop();
						var d = this.project(this.getCenter()),
							_ = this.project(t),
							m = this.getSize(),
							p = this._zoom;
						t = o.latLng(t), e = void 0 === e ? p : e;
					...
					project: function(t, e) {
						return e = void 0 === e ? this._zoom : e, this.options.crs.latLngToPoint(o.latLng(t), e)
					},
					unproject: function(t, e) {
						return e = void 0 === e ? this._zoom : e, this.options.crs.pointToLatLng(o.point(t), e)
					},
					...
					_fireDOMEvent: function(t, e, i) {
						...
						if(!t._stopped && (i = (i || []).concat(this._findEventTargets(t, e)), i.length)) {
							...
							for(var h = 0; h < i.length; h++)
								if(i[h].fire(e, r, !0), r.originalEvent._stopped || i[h].options.nonBubblingEvents && -1 !== o.Util.indexOf(i[h].options.nonBubblingEvents, e)) return
						}
					},
			...
			o.DomEvent = {
				...
				_on: function(e, i, n, r) {
					...
					}), e.addEventListener(i, h, !1)) : "attachEvent" in e && e.attachEvent("on" + i, h), e[s] = e[s] || {}, e[s][a] = h, this
				},
				...
				_setAutoZIndex: function(t) {
					for(var e, i = this.getPane().children, o = -t(-1 / 0, 1 / 0), n = 0, s = i.length; n < s; n++) e = i[n].style.zIndex, i[n] !== this._container && e && (o = t(o, +e));
				...
				_updateLevels: function() {
					...
					if(void 0 !== t) {
						...
						var n = this._levels[t],
							s = this._map;
						return n || (n = this._levels[t] = {}, n.el = o.DomUtil.create("div", "leaflet-tile-container leaflet-zoom-animated", this._container), n.el.style.zIndex = e, n.origin = s.project(s.unproject(s.getPixelOrigin()), t).round(), n.zoom = t, this._setZoomTransform(n, s.getCenter(), s.getZoom()), o.Util.falseFn(n.el.offsetWidth)), this._level = n, n
					}
				},
				...
				_setView: function(t, e, i, o) {
					...
					o && !s || (this._tileZoom = n, this._abortLoading && this._abortLoading(), this._updateLevels(), this._resetGrid(), void 0 !== n && this._update(t), i || this._pruneTiles(), this._noPrune = !!i), this._setZoomTransforms(t, e)
				},
				...
				_update: function(t) {
					...
					if(i) {
						...
						if(void 0 === t && (t = i.getCenter()), void 0 !== this._tileZoom) {
							...
							for(var _ = r.min.y; _ <= r.max.y; _++)
								for(var m = r.min.x; m <= r.max.x; m++) {
				...
				_getZoomForUrl: function() {
					var t = this._tileZoom,
						...
						n = this.options.minNativeZoom,
						s = this.options.maxNativeZoom;
					return i && (t = e - t), t += o, null !== n && t < n ? n : null !== s && t > s ? s : t
				},
				...
				_updateLayout: function() {
					...
					s && n > s ? (e.height = s + "px", o.DomUtil.addClass(t, "leaflet-popup-scrolled")) : o.DomUtil.removeClass(t, "leaflet-popup-scrolled"), this._containerWidth = this._container.offsetWidth
				},
				_animateZoom: function(t) {
				...
				invoke: function(t) {
					...
					for(e in this._layers) i = this._layers[e], i[t] && i[t].apply(i, o);
					return this
				},
				onAdd: function(t) {
				...
				clipSegment: function(t, e, i, o, n) {
					...
					for(this._lastCode = l;;) {
						if(!(h | l)) return [t, e];
						if(h & l) return !1;
						s = h || l, r = this._getEdgeIntersection(t, e, s, i, n), a = this._getBitCode(r, i), s === h ? (t = r, h = a) : (e = r, l = a)
					}
				},
				...
				getCenter: function() {
					...
					for(t = 0, o = 0; t < h - 1; t++)
						if(n = a[t], s = a[t + 1], i = n.distanceTo(s), (o += i) > e) return r = (o - e) / i, this._map.layerPointToLatLng([s.x - r * (s.x - n.x), s.y - r * (s.y - n.y)])
				},
				getBounds: function() {
					return this._bounds
				},
				...
				_clipPoints: function() {
					...
					if(this._parts = [], this._pxBounds && this._pxBounds.intersects(t)) {
						...
						for(e = 0, n = 0, s = this._rings.length; e < s; e++)
							for(h = this._rings[e], i = 0, r = h.length; i < r - 1; i++)(a = o.LineUtil.clipSegment(h[i], h[i + 1], t, i, !0)) && (l[n] = l[n] || [], l[n].push(a[0]), a[1] === h[i + 1] && i !== r - 2 || (l[n].push(a[1]), n++))
					}
				},
				...
				getCenter: function() {
					...
					var t, e, i, o, n, s, r, a, h, l = this._rings[0],
						u = l.length;
					if(!u) return null;
					for(s = r = a = 0, t = 0, e = u - 1; t < u; e = t++) i = l[t], o = l[e], n = i.y * o.x - o.y * i.x, r += (i.x + o.x) * n, a += (i.y + o.y) * n, s += 3 * n;
					...
					if(this._drawing) {
						...
						if(a) {
							for(this._drawnLayers[t._leaflet_id] = t, h.beginPath(), h.setLineDash && h.setLineDash(t.options && t.options._dashArray || []), i = 0; i < a; i++) {
								for(o = 0, n = r[i].length; o < n; o++) s = r[i][o], h[o ? "lineTo" : "moveTo"](s.x, s.y);
								e && h.closePath()
							}
				...
				coordsToLatLngs: function(t, e, i) {
					for(var o, n = [], s = 0, r = t.length; s < r; s++) o = e ? this.coordsToLatLngs(t[s], e - 1, i) : (i || this.coordsToLatLng)(t[s]), n.push(o);
					return n
				},
			...
			o.Marker.include(r), o.Circle.include(r), o.CircleMarker.include(r), o.Polyline.prototype.toGeoJSON = function() {
					...
					addDoubleTapListener: function(t, e, i) {
						function n(t) {
							if(!((o.Browser.pointer ? o.DomEvent._pointersCount : t.touches.length) > 1)) {
								var e = Date.now(),
									i = e - (r || e);
								a = t.touches ? t.touches[0] : t, h = i > 0 && i <= l, r = e
							}
						}
					...
					_onTouchEnd: function() {
						...
						this._zooming = !1, o.Util.cancelAnimFrame(this._animRequest), o.DomEvent.off(e, "touchmove", this._onTouchMove).off(e, "touchend", this._onTouchEnd), this._map.options.zoomAnimation ? this._map._animateZoom(this._center, this._map._limitZoom(this._zoom), !0, this._map.options.zoomSnap) : this._map._resetView(this._center, this._map._limitZoom(this._zoom))
					}
					...
					_simulateEvent: function(i, o) {
						...
						n._simulated = !0, o.target._simulatedClick = !0, n.initMouseEvent(i, !0, !0, t, 1, o.screenX, o.screenY, o.clientX, o.clientY, !1, !1, !1, !1, 0, null), o.target.dispatchEvent(n)
					}
				...
				o.Map.BoxZoom = o.Handler.extend({
					...
					_onMouseDown: function(t) {
						...
						this._resetState(), o.DomUtil.disableTextSelection(), o.DomUtil.disableImageDrag(), this._startPoint = this._map.mouseEventToContainerPoint(t), o.DomEvent.on(e, {
					...
					_onMouseDown: function() {
						if(!this._focused) {
							...
							this._map._container.focus(), t.scrollTo(s, n)
						}
					},
					_onFocus: function() {
					...
					_addItem: function(t) {
						...
						return n.appendChild(a), a.appendChild(i), a.appendChild(r), (t.overlay ? this._overlaysList : this._baseLayersList).appendChild(n), this._checkDisabledLayers(), n
					},
					_onInputClick: function() {
						...
						for(var r = o.length - 1; r >= 0; r--) t = o[r], e = this._getLayer(t.layerId).layer, i = this._map.hasLayer(e), t.checked && !i ? n.push(e) : !t.checked && i && s.push(e);
						for(r = 0; r < s.length; r++) this._map.removeLayer(s[r]);
						for(r = 0; r < n.length; r++) this._map.addLayer(n[r]);
						this._handlingClick = !1, this._refocusOnMap()
					},
					_checkDisabledLayers: function() {
						for(var t, e, i = this._form.getElementsByTagName("input"), o = this._map.getZoom(), n = i.length - 1; n >= 0; n--) t = i[n], e = this._getLayer(t.layerId).layer, t.disabled = void 0 !== e.options.minZoom && o < e.options.minZoom || void 0 !== e.options.maxZoom && o > e.options.maxZoom
					},
					_expand: function() {
						return this.expand()
					},
		...
		! function(e, t) {
			...
			function u(t, n) {
				function i(e) {
					...
					o = new RegExp(r(e[0]) + "\\s*"), a = new RegExp("\\s*" + r(e[1])), u = new RegExp("\\s*" + r("}" + e[1]))
				}
				if(!t) return [];
				var o, a, u, h = [],
					f = [],
				...
				for(var y, U, T, j, S, V, C = new l(t); !C.eos();) {
					if(y = C.pos, T = C.scanUntil(o))
						for(var A = 0, I = T.length; A < I; ++A) j = T.charAt(A), s(j) ? d.push(f.length) : w = !0, f.push(["text", j, y, y + 1]), y += 1, "\n" === j && function() {
							if(v && !w)
			...
			l.prototype.eos = function() {
				...
				for(var i, o, s, a = "", u = 0, c = e.length; u < c; ++u) s = void 0, i = e[u], o = i[0], "#" === o ? s = this.renderSection(i, t, n, r) : "^" === o ? s = this.renderInverted(i, t, n, r) : ">" === o ? s = this.renderPartial(i, t, n, r) : "&" === o ? s = this.unescapedValue(i, t) : "name" === o ? s = this.escapedValue(i, t) : "text" === o && (s = this.rawValue(i)), void 0 !== s && (a += s);
				return a
		...
		module.exports = function(e, r) {
			...
			return util.strict(e, "string"), -1 === e.indexOf("/") && (e = format_url("/geocoding/v5/" + e + "/{query}.json", r.accessToken, 5)), n.getURL = function() {
				...
				if(e.length && e[0].length) {
					for(var i = 0, a = []; i < e.length; i++) a.push(o(e[i]));
					u = a.join(";")
				} else u = o(e);
				return request(n.queryURL(u), function(e, t) {
					r(e, t)
				}), n
			}, n
		};
