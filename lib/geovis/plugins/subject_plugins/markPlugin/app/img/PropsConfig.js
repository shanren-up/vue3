...
export const style = {
    ...
    'altitude-clamping': {
        ...
        options: {
            ...
            terrainE_scene: 'terrain-scene',
            relative_scene: 'relative-scene'
        }
    },
    'altitude-technique': {
        label: '贴地方法',
    ...
    'stroke-min-pixels': {
        label: '最小渲染宽度（线宽不为位像素时有效）',
        type: htmlType.NUMBER
    },
    'stroke-linecap': {
        label: '线端点处理（线宽不为位像素时有效）',
        type: htmlType.SELECT,
        options: {
            'square': 'square',
            'flat': 'flat',
    ...
    'effect-offset-x': {
        label: '点特效与绑定对象的相对x位置',
        type: htmlType.NUMBER
    },
    'effect-offset-y': {
        label: '点特效与绑定对象的相对y位置',
        type: htmlType.NUMBER
    },
}
