...
class TimeWidget extends GV.Widget{
	...
	setSXYX(v) { 
//			getCurrenCursorTime().getFullYear();
//			getCurrenCursorTime().getMonth();
//			getCurrenCursorTime().getDate();
//			getCurrenCursorTime().getHours();
//			getCurrenCursorTime().getMinutes();
//			getCurrenCursorTime().getSeconds();
			var str = v.getFullYear()+";"+(1+v.getMonth())+";"+v.getDate()+";"+v.getHours()+";"+v.getMinutes()+";"+v.getSeconds()
			this.tw.postMessage('sxyx',str); 
	}
	init() {
...
//				console.log(getCurrenCursorTime())
		...
		var this_ = this;
		$(".SXTime").mouseup(function(){
			this_.setSXYX(getCurrenCursorTime())
		...
		$(".SXReduceBtn").click(() => {
			...
			$(".SXDet").html(getCurrenCursorTime())
			this.setSXYX(getCurrenCursorTime())
//			this.tw.postMessage('sxyx',"2017;01;30;10;10;10"); 
		...
		$(".SXScaleBtn").click(()=>{
			...
			$(".SXDet").html(getCurrenCursorTime())
//			this.setSXYX("2006;10;10;10;10;10")
			this.setSXYX(getCurrenCursorTime())
		})
		//获取 判断条件 及参数
