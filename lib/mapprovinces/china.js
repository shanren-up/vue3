define(
    ...
    function() {
        ...
        (function() {
            ...
            provinces = {
                an_hui: require("echarts/util/mapData/geoJson/an_hui_geo"),
                ao_men: require("echarts/util/mapData/geoJson/ao_men_geo"),
                bei_jing: require("echarts/util/mapData/geoJson/bei_jing_geo"),
                china: require("echarts/util/mapData/geoJson/china_geo"),
                zhe_jiang: require("echarts/util/mapData/geoJson/zhe_jiang_geo"),

                yun_nan: require("echarts/util/mapData/geoJson/yun_nan_geo"),
                xi_zang: require("echarts/util/mapData/geoJson/xi_zang_geo"),
                xin_jiang: require("echarts/util/mapData/geoJson/xin_jiang_geo"),
                xiang_gang: require("echarts/util/mapData/geoJson/xiang_gang_geo"),
                ji_lin: require("echarts/util/mapData/geoJson/ji_lin_geo"),

                shan_xi_2: require("echarts/util/mapData/geoJson/shan_xi_1_geo"),
                shan_xi_1: require("echarts/util/mapData/geoJson/shan_xi_2_geo"),
                si_chuan: require("echarts/util/mapData/geoJson/si_chuan_geo"),
                tai_wan: require("echarts/util/mapData/geoJson/tai_wan_geo"),
                tian_jin: require("echarts/util/mapData/geoJson/tian_jin_geo"),

                shan_dong: require("echarts/util/mapData/geoJson/shan_dong_geo"),
                ...
                jiang_su: require("echarts/util/mapData/geoJson/jiang_su_geo"),
                hu_nan: require("echarts/util/mapData/geoJson/hu_nan_geo"),
                hu_bei: require("echarts/util/mapData/geoJson/hu_bei_geo"),
                he_nan: require("echarts/util/mapData/geoJson/he_nan_geo"),

                he_bei: require("echarts/util/mapData/geoJson/he_bei_geo"),
                hei_long_jiang: require("echarts/util/mapData/geoJson/hei_long_jiang_geo"),
                hai_nan: require("echarts/util/mapData/geoJson/hai_nan_geo"),
                gui_zhou: require("echarts/util/mapData/geoJson/gui_zhou_geo"),
                guang_xi: require("echarts/util/mapData/geoJson/guang_xi_geo"),

                guang_dong: require("echarts/util/mapData/geoJson/guang_dong_geo"),
                gan_su: require("echarts/util/mapData/geoJson/gan_su_geo"),
                fu_jian: require("echarts/util/mapData/geoJson/fu_jian_geo"),
                chong_qing: require("echarts/util/mapData/geoJson/chong_qing_geo"),
