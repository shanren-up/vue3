(function()
{
    ...
    (function()
    {
        ...
        Slice.defineEnum = function(enumerators)
        {
            ...
            var maxValue = 0;
            var firstEnum = null;
            for(var idx =0; idx < enumerators.length; idx++)
            {
    ...
    (function()
    {
        ...
        {
            //
            // For a long to be valid both words must be within the range of INT32
            //
            return v.low >= MIN_INT32_VALUE && v.low <= MAX_INT32_VALUE && 
                   v.high >= MIN_INT32_VALUE && v.high <= MAX_INT32_VALUE;
        };
